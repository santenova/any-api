...
class HubTestsAgent(AgentBase):
    def __init__(self,max_retries=2, verbose=True):
        super().__init__(name="HubTestsAgent", max_retries=max_retries, verbose=verbose)
    ...
    def execute(self, repo_name):
        ...
        #test_analysis = self.call_llama(messages, max_tokens=1000)
        return messages
